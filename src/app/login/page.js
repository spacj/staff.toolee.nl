...
import { Shield, Mail, Lock, Eye, EyeOff, ArrowRight, Building, UserPlus, Users, Clock, BarChart3, Heart } from 'lucide-react';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-gradient-to-br from-slate-50 via-white to-brand-50/30">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mt-8 pt-6 border-t border-slate-200 flex items-center justify-center gap-2 text-sm text-slate-500">
