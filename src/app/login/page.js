...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Building, UserPlus, Users, Clock, BarChart3 } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-gradient-to-br from-slate-50 via-white to-brand-50/30">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600">Sign in to your Staff2 account</p>
          </div>
